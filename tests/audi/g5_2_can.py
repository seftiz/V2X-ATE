...
class TC_G5_2_CAN(common.V2X_SDKBaseTest):
    """
    @class TC_G5_2_CAN
    """
    ...
    def __init__(self, methodName = 'runTest', param = None):
        ...
        super(TC_G5_2_CAN, self).__init__(methodName, param)
    
    
    def get_test_parameters( self ):
        # Call father class
        super(TC_G5_2_CAN, self).get_test_parameters()
    ...
    def main(self):
        ...
        try:
            for cam_msg in test_sequence:
                ...
                g5_data = pyshark.LiveCapture( interface = self.sniffer.get_interface_name( 0 ) , display_filter = filter )
                for packet in g5_data.sniff_continuously(packet_count = TOTAL_PKT_CNT):
