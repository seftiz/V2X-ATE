...
class IQ2010_VSA(IQ2010_Instrumet):
    ...
    def analyze_802_11p( self, ph_corr_mode = 3, ch_estimate = 1, sym_tim_corr=2, freq_sync=2, ampl_track = 1, ofdm_mode = 2 ):
        """
...
class IQ2010(object):
    ...
    def __init__( self, dll_lib = r"C:\sysHW\lib\instruments\VSA_IQ2010\IQMeasure"):       
        os.chdir( dll_lib )
