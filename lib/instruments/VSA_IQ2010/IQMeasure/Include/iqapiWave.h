...
*/
#pragma once
#ifndef IQAPI_WAVE_H_
#define IQAPI_WAVE_H_
...
enum IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPES
{
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_None,              // clean wave
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_1_POS_FREQ_DRIFT,  // 1a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_1_NEG_FREQ_DRIFT,  // 1b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_2_POS_FREQ_DRIFT,  // 2a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_2_NEG_FREQ_DRIFT,  // 2b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_3_POS_FREQ_DRIFT,  // 3a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_3_NEG_FREQ_DRIFT,  // 3b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_4_POS_FREQ_DRIFT,  // 4a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_4_NEG_FREQ_DRIFT,  // 4b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_5_POS_FREQ_DRIFT,  // 5a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_5_NEG_FREQ_DRIFT,  // 5b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_6_POS_FREQ_DRIFT,  // 6a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_6_NEG_FREQ_DRIFT,  // 6b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_7_POS_FREQ_DRIFT,  // 7a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_7_NEG_FREQ_DRIFT,  // 7b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_8_POS_FREQ_DRIFT,  // 8a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_8_NEG_FREQ_DRIFT,  // 8b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_9_POS_FREQ_DRIFT,  // 9a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_9_NEG_FREQ_DRIFT,  // 9b
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_10_POS_FREQ_DRIFT, // 10a
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPE_10_NEG_FREQ_DRIFT  // 10b
};
...
public :
	...
	int Save(const char* modFileName); //!< \see iqapiWaveBase::Save(const char* modFileName)
	...
	IQV_WAVE_BLUETOOTH_LE_DIRTY_PACKET_TYPES leDirtyPacketType; //!< Sets LE dirty packet type per RCV-LE/CA/01/C
...
public :
	...
	virtual int Save(const char* modFileName); //!< \see iqapiWaveBase::Save(const char* modFileName)
