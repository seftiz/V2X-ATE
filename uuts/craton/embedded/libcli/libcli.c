...
#include <stdlib.h>
#ifdef THREADX
// TODO - when threadx sdk is available take these files from their corect location (define -I option at makefile)
#ifdef SDK_FOR_THREADX
#include <nx_bsd.h>
#endif /*SDK_FOR_THREADX*/
#else
#include <memory.h>
#endif /* THREADX */
...
#include <ctype.h>
#include <unistd.h>
/* TODO - time include is part of libc but does not compile under threadx. 
 due to gettimeofday error
*/
#if !defined(THREADX) || (defined(THREADX) && defined(SDK_FOR_THREADX_TIME_SUPPORT))
#include <time.h>
#endif /* SDK_FOR_THREADX_TIME_SUPPORT */
#ifndef WIN32
// TODO add the regex lib path to the makefile
#include <regex.h>
#endif
#include "libcli.h"
