...
# by libsmi2pysnmp-0.1.3 at Sun Aug 25 17:51:49 2013,
...
vcaMib = ModuleIdentity((1, 3, 6, 1, 4, 1, 38405, 1, 5)).setRevisions(("2012-12-20 00:00",))
...
vcaFrameLen = MibTableColumn((1, 3, 6, 1, 4, 1, 38405, 1, 5, 4, 1, 2), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(0, 1500))).setMaxAccess("readwrite")
...
vcaMibGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 38405, 1, 5, 1, 1, 1)).setObjects(*(("AUTOTALKS-VCA-MIB", "vcaFrameLen"), ("AUTOTALKS-VCA-MIB", "vcaTxPeriod"), ("AUTOTALKS-VCA-MIB", "vcaTxEnabled"), ("AUTOTALKS-VCA-MIB", "vcaLogMode"), ) )
...
# Objects
mibBuilder.exportSymbols("AUTOTALKS-VCA-MIB", vcaMib=vcaMib, vcaConformance=vcaConformance, vcaGroups=vcaGroups, vcaCompliances=vcaCompliances, vcaLogMode=vcaLogMode, vcaIfTable=vcaIfTable, vcaIfEntry=vcaIfEntry, vcaTxPeriod=vcaTxPeriod, vcaFrameLen=vcaFrameLen, vcaTxEnabled=vcaTxEnabled)
